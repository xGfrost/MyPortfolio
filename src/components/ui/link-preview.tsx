...
import { AnimatePresence, cubicBezier, motion, useMotionValue, useSpring } from "framer-motion";
                ...
                <HoverCardPrimitive.Content className="[transform-origin:var(--radix-hover-card-content-transform-origin)]" side="top" align="center" sideOffset={10}>
                    <AnimatePresence>
                        {isOpen && (
                            ...
                            >
                                <Link href={url} className="block p-1 bg-white border-2 border-transparent shadow rounded-xl hover:border-neutral-200 dark:hover:border-neutral-800" style={{ fontSize: 0 }} onClick={() => lenis && lenis.scrollTo(url, { offset: -100, easing: cubicBezier(0.65, 0, 0.35, 1), duration: 1 })}>
